    ...
    <main className="min-h-screen">
      ...
      <section className="relative bg-dark overflow-hidden pt-32 pb-16">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          <p className="font-mono text-xs text-accent tracking-widest uppercase mb-4">{t.contact.label}</p>
          <h1 className="font-display text-5xl md:text-6xl font-bold text-white leading-tight">
            {t.contact.title}<br />
            <span className="italic font-normal text-white/40">{t.contact.title_italic}</span>
          </h1>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6 py-20">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-12">
            ...
            <div className="space-y-8">
              <div>
                <p className="font-mono text-xs text-muted tracking-widest uppercase mb-2">Email</p>
                <a
                  href="mailto:anamaria.sveric@gmail.com"
                  className="font-body text-xl text-ink hover:text-accent transition-colors duration-300 underline underline-offset-4 decoration-ink/20 hover:decoration-accent"
                >
              ...
              <div>
                <p className="font-mono text-xs text-muted tracking-widest uppercase mb-2">{t.contact.phone_label}</p>
                <div className="flex items-center gap-3 flex-wrap">
                  <a
                    href="tel:+385917938803"
                    className="font-body text-xl text-ink hover:text-accent transition-colors duration-300"
                  >
                    +385 91 793 8803
                  </a>
                  <a
              ...
              {/* CV */}
              <div>
                <p className="font-mono text-xs text-muted tracking-widest uppercase mb-2">{t.contact.cv_label}</p>
                <div className="flex items-center gap-3">
                  ...
                  {cvDate && (
                    <span className="font-mono text-xs text-ink/30">{t.hero.cv_updated} {cvDate}</span>
                  )}
                </div>
              </div>
              ...
              {/* Društvene mreže */}
              <div>
                <p className="font-mono text-xs text-muted tracking-widest uppercase mb-3">{t.contact.social_label}</p>
                <div className="flex items-center gap-4">
                  <a href="https://www.facebook.com/anamaria.1058" target="_blank" rel="noopener noreferrer" className="text-ink/40 hover:text-accent transition-colors duration-300" aria-label="Facebook">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                  </a>
                  <a href="https://www.instagram.com/anamsveric" target="_blank" rel="noopener noreferrer" className="text-ink/40 hover:text-accent transition-colors duration-300" aria-label="Instagram">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://www.threads.net/@anamsveric" target="_blank" rel="noopener noreferrer" className="text-ink/40 hover:text-accent transition-colors duration-300" aria-label="Threads">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
